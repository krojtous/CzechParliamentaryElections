...
makeBubbleMatrixTable201310 = function(variable = "PI_1a", cluster_count = 3, limit = 3){
    ...
    library(foreign)
    cvvm = read.spss(file = "C:/Dokumenty/CVVM/CzechParliamentaryElections/data/V1310/V1310_F1.sav",
                     to.data.frame = TRUE,
    ...
    results = read.csv(file = "C:/Dokumenty/CVVM/CzechParliamentaryElections/results.csv",
                       sep = ";",
                       dec = ",")
